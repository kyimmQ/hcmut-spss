  ...
  const exampleData = [
    {
      ...
      time: "17:00:24",
      date: "18/11/2023",
      accountName: "Lê Duy Anh",
      accountNameTag: "anh.leduy04",
      transactionID: "T-Pa-001",
      printerID: "BK-LTK-001",
      docName: "Software-Engineer-Document.docs",
      pageNumber: "100",
      confirmation: true,
      status: true,
      delivery: true,
    },
    {
      ...
      time: "08:30:29",
      date: "29/10/2023",
      accountName: "Nguyễn Trần Bảo Ngọc",
      accountNameTag: "ngoc.nguyentran",
      transactionID: "T-Pa-010",
      printerID: "BK-DiAn-001",
      docName: "Data-Structure-and-Algorithms-Textbook.pdf",
      pageNumber: "20",
      confirmation: true,
      status: true,
      delivery: false,
    },
    {
      ...
      accountName: "Nguyễn Trần Bảo Ngọc",
      accountNameTag: "ngoc.nguyentran",
      transactionID: "T-Pa-100",
      printerID: "BK-LTK-009",
      docName: "Introduction-to-Artificial-Intelligence-Slide.pptx",
      pageNumber: "300",
      confirmation: true,
      status: false,
      delivery: false,
    },
    {
      ...
      printerID: "BK-LTK-001",
      docName:
        "Mark Richards, Neal Ford - Fundamentals of Software Architecture_ An Engineering Approach-O'Reilly Media (2020).pdf",
      pageNumber: "100",
      confirmation: true,
      status: true,
      delivery: true,
    },
    {
      ...
      transactionID: "T-Pa-010",
      printerID: "BK-DiAn-001",
      docName: "01_Ch1 Introduction_2023.pdf",
      pageNumber: "20",
      confirmation: true,
      status: true,
      delivery: false,
    },
    {
      ...
      transactionID: "T-Pa-100",
      printerID: "BK-LTK-009",
      docName: "03_Ch3_4 Requirements Engineering_2023.pdf",
      pageNumber: "22",
      confirmation: true,
      status: false,
      delivery: false,
    },
    {
      ...
      transactionID: "T-Pa-001",
      printerID: "BK-LTK-001",
      docName: "08_Ch8 Implementation_2023.pdf",
      pageNumber: "15",
      confirmation: true,
      status: true,
      delivery: true,
    },
    {
      ...
      transactionID: "T-Pa-010",
      printerID: "BK-DiAn-001",
      docName: "10_Ch10 Agile Methodology_2023.pdf",
      pageNumber: "20",
      confirmation: true,
      status: true,
      delivery: false,
    },
    {
      ...
      transactionID: "T-Pa-100",
      printerID: "BK-LTK-009",
      docName: "02_Ch2 Software Processes_2023.pdf",
      pageNumber: "10",
      confirmation: true,
      status: false,
      delivery: false,
